...
*/
	...
	if(char1[0]=='+' && char1[1]=='Q' && char1[2]=='B' && char1[3]=='T' && char1[4]=='A' && char1[5]=='C' && char1[6]=='P' && char1[7]=='T')
	{
 ...
 //   sleep(1);
	...
	read(fd,char1,sizeof(char1));
	//printf("%s",char1);
	if(char1[10]=='c' && char1[11]=='o' && char1[12]=='n' && char1[13]=='n')
	{
...
{
	int len,i;char count[4],final[60];
	memset(count,'\0',sizeof(count));
	memset(final,'\0',sizeof(final));
	char start[7]="echo ~E",end[16]="! > /dev/printer";
