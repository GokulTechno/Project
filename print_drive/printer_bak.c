...
if(size==2)
{
				...
				for(height=0;height<23;height++)
				{
					for(width=1;width<=32 && width<(data_size-3);width++)
					{
						...
						break;
						case 2:
						envy[width]=Courier12reg[data[width]][height];
						break;
						default:
						break;
						}
						...
						break;
						case 2:
						envy[width]=Courier12bold[data[width]][height];
						break;
						default:
						break;
						}						
...
if(size==3)   
{
				...
				{
					for(width=1;width<= 27 && width<(data_size-3);width++)
					{
						...
						break;
						case 2:
						envy[width]=Courier15reg[data[width]][height];
						break;
						default:
						break;
						}	
						...
						break;
						case 2:
						envy[width]=Courier15bold[data[width]][height];
						break;
						default:
						break;
						}
...
static int __init printer_init(void)   
{
	...
	gpio_direction_output(226,1);// --------------logic power -----------
	udelay(50);
	gpio_direction_output(137,1);// --------------Driver IC enable -----------   
