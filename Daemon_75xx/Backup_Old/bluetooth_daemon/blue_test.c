...
{
fscan = fopen("/opt/daemon_files/bscan", "r");
...
if(bscan_buff[0]=='1')
{
	...
	read(fd,read_buffer,sizeof(read_buffer));
//	if(read_buffer[0]=='+' && read_buffer[1]=='Q' && read_buffer[2] == 'B' && read_buffer[3]=='T' && read_buffer[4]=='S' && read_buffer[5]=='C' && read_buffer[6]=='A' && read_buffer[7]=='N' && read_buffer[8]==':' && read_buffer[9]==' ')
		if(read_buffer[9]==' ')
		{
...
//	else if(read_buffer[0]=='+' && read_buffer[1]=='Q' && read_buffer[2] == 'B' && read_buffer[3]=='T' && read_buffer[4]=='S' && read_buffer[5]=='C' && read_buffer[6]=='A' && read_buffer[7]=='N' && read_buffer[8]==':' && read_buffer[9]=='0' )
